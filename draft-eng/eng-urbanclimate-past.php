...
<?php include('navbar.php'); ?>
    ...
    <div class="container my-3">
        ...
        <!-- 歷史專案區域 - 使用第一段的顯示風格但保留第二段的JavaScript功能 -->
        <div class="card mb-4" id="history-section">
            <h2 class="card-header">Street Block Microclimate Project History List</h2>
            <div id="section-card-list">
                <div class="filter-project-list-section" id="projectListSection">
                    ...
                    <!-- Retaining the original pagination control section -->
        ...
        <div id="drawingSection">
            ...
            <div class="project-name-display">
                ...
                <button class="button" onclick="deleteProject()" style="background-color:rgb(212, 157, 38);">🗑️ 刪除專案</button>
                <button class="button" onclick="saveProject()">💾 儲存專案</button>
                <button class="button" onclick="saveAsProject()">📝 另存專案</button>
                <!-- <button class="button" onclick="loadProjectList()">📂 查看其他專案</button> -->
                <button class="button" onclick="confirmNavigation()">📂 查看其他專案</button>
                </div>
            ...
            fetch('?action=list')
                ...
                .catch(error => {
                    ...
                    document.getElementById('projectList').innerHTML = `
                        <div class="error">載入專案列表時發生錯誤</div>`;
                });
        }
                            ...
                            <div class="d-flex justify-content-between align-items-start">
                                <div>
                                    ...
                                    <div class="d-flex align-items-center mt-2">
                                        <span class="badge bg-info">Number of Buildings: ${project.ShapeCount}</span>
                                        <div class="mx-2">|</div>
                                        <small class="text-muted">Created Date: ${new Date(project.CreatedDate).toLocaleDateString()}</small>
                                    </div>
                                </div>
                            </div>
                        </div>
