...
<body>
    ...
    <h1 class="text-2xl font-bold">Green Building Data Setup</h1>
    ...
    <div class="container mx-auto p-4">
        ...
        <div class="mb-4">
        <h2 class="text-xl font-bold" data-i18n="createProject">Create New Project</h2>
        </div>
        ...
        <?php else: ?>
            <form id="projectForm" class="space-y-4">
                <div>
                <label for="projectName" class="block font-medium" data-i18n="projectName">Project Name</label>
                <input
                        type="text"
                        id="projectName"
                        name="projectName"
                ...
                <div>
                <label for="projectAddress" class="block font-medium" data-i18n="projectAddress">Project Address</label>
                <input
                        type="text"
                        id="projectAddress"
                        name="projectAddress"
                        class="input-field"
                        placeholder="Please enter project address"
                        required
                    >
                </div>
